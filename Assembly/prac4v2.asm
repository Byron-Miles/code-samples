...
section .data
   ...
   oppExpErr    db    'Exceeds 18,446,744,073,709,551,615'
   oppExpLen    equ   $ - expOverMsg;Length (in bytes) of expOverMsg
...
oppexp_recurse:
   ...
   call   _oppexp_overflow             ;Call overflow function
...
_oppexp_overflow:                      ;Displays an overflow error
   push   rbx                       ;Save register b
                                    ;Display the error message
