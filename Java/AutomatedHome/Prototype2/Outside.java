...
public class Outside
{
   ...
   //The forecast minimum tempurature for that day
   private int m_iTempForecastMin;
   //The forecast maximum tempurature for that day
   private int m_iTempForecastMax;
   ...
   public Outside()
   {
      ...
      m_iRainForecast = rand.nextInt(31);
      m_bWaterAuto = false;
      m_iWaterFront = 0;
      m_iWaterBack = 0;
      m_iWaterGarden = 0;
      ...
      m_iTempForecastMin = rand.nextInt(10);
      m_iTempForecastMax = rand.nextInt(16) + 15;
      m_iTempLevel = 15;
   ...
   public int getTempForecastMin()
   {
      return m_iTempForecastMin;
   }

   //Get the forcast maximum tempurature
   public int getTempForecastMax()
   {
      return m_iTempForecastMax;
   }
   ...
   //Set the tempurature setting for the outside heater, 15 is off
